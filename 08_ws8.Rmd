...
For the ANOVA model, you should look for partial eta squared ($η_P^2$). This is super quick and easy to check from the ANOVA model `mod` using this code:
...
> **Question 14: Which plot tells us about the main effect of distraction?** <select id="q14" onchange="checkAnswer('q14','B')"> <option value="">-- choose an answer --</option> <option value="A">A. Plot 1 (p1)</option> <option value="B">B. Plot 2 (p2)</option> <option value="C">C. Plot 3 (p3)</option> </select>
> **Question 15: Which plot tells us about the main effect of hazard?** <select id="q15" onchange="checkAnswer('q15','A')"> <option value="">-- choose an answer --</option> <option value="A">A. Plot 1 (p1)</option> <option value="B">B. Plot 2 (p2)</option> <option value="C">C. Plot 3 (p3)</option> </select>
