...
\chapter{Workshop 7: Factorial ANOVA: Factorial Designs and an Interactions}\label{workshop-7-factorial-anova-factorial-designs-and-an-interactions}
...
\FunctionTok{ggplot}\NormalTok{(longd, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ time, }\AttributeTok{y =}\NormalTok{ wellbeing, }\AttributeTok{fill =}\NormalTok{ exercise)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}
    ...
    \AttributeTok{y =} \StringTok{"Mean Wellbeing Score"}\NormalTok{) }\SpecialCharTok{+}
