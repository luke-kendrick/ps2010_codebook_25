...
\begin{Highlighting}[]
\NormalTok{mydata }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(}\AttributeTok{city =} \StringTok{"canterberry"}\NormalTok{, degree }\SpecialCharTok{==}\NormalTok{ medicine)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mydata }\OtherTok{=}
  \FunctionTok{filter}\NormalTok{(city }\SpecialCharTok{==} \StringTok{"London"}\NormalTok{, pet }\SpecialCharTok{==} \StringTok{"hamsta"}\NormalTok{, coffee }\SpecialCharTok{\textgreater{}}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  \texttt{before:after} will then take all and any columns from \texttt{before} through to \texttt{after} and re-arrange them into long data format.
\end{itemize}
...
\NormalTok{desc }\OtherTok{\textless{}{-}}\NormalTok{ longd }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(}\ConstantTok{NULL}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_sleep =} \FunctionTok{mean}\NormalTok{(}\ConstantTok{NULL}\NormalTok{)}
            \AttributeTok{sd\_sleep =} \FunctionTok{sd}\NormalTok{(}\ConstantTok{NULL}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

Change \texttt{NULL1} to the name of the independent variable in the \texttt{long} data file, and \texttt{NULL2} to the dependent variable. Use \texttt{names(long)} if you need a reminder.
