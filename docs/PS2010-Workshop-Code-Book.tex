...
\item
  Pay careful attention to the lay out of this code. For example, notice where brackets open and close, and the plavement of commas to move on the the next line.
\end{itemize}
