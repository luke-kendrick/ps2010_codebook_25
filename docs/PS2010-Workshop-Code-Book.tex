...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(tudyverse)}
\FunctionTok{library}\NormalTok{(rstatix)}
\end{Highlighting}
\end{Shaded}

Import the data set called \texttt{exercise.csv}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(mydata\_long, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ time, }\AttributeTok{y =}\NormalTok{ exercise)) }\SpecialCharTok{+}
...
\NormalTok{longd }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{pairwise\_wilcox\_test}\NormalTok{(}
    \ConstantTok{NULL} \SpecialCharTok{\textasciitilde{}}\NormalTok{ BULL,}
    \AttributeTok{paired =} \ConstantTok{TRUE}\NormalTok{,}
    \AttributeTok{p.adjust.method =} \StringTok{"holm"}\NormalTok{)}
    
\FunctionTok{wilcox\_effsize}\NormalTok{(NULLL }\SpecialCharTok{\textasciitilde{}} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{data =}\NormalTok{ longd, }\AttributeTok{paired =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Code for Mann-Whitney U (or Wilcoxon Rank-Sum)}\label{code-for-mann-whitney-u-or-wilcoxon-rank-sum}
...
\section{Code for Kruskal-Wallis}\label{code-for-kruskal-wallis}
...
\section{Code for Wilcoxon-Signed Rank}\label{code-for-wilcoxon-signed-rank}
...
\section{Code for Friedman's ANOVA}\label{code-for-friedmans-anova}
